...
#
#             upon adding a editor to the system it is expected to be redirected to the
#             edit view for the new editor. or possibly the editor itself.
#
...
#
#         """ this can potentially add additional restrictions to what users can add a editor and where.
...
#
#
#     description = _('Create a new Topic under this editor.'),
#
#     # prevents forcing of edit mode on success, most likely will not be changing this setting
#     # edit_mode_on_success = False,
# )
...
#
#
#     description = _('Create a new Section under this editor.'),
#
#     # prevents forcing of edit mode on success, most likely will not be changing this setting
#     # edit_mode_on_success = False,
# )
